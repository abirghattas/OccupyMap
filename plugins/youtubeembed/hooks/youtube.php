...
class youtube {
	...
	private function _embed_code($id = NULL)
	{
		if ($id)
		{
			return '<div style="margin:15px 0 15px 0"><object width="495" height="300"><param name="movie" value="http://www.youtube.com/v/'.$id.'&hl=en&fs=1&"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/'.$id.'&hl=en&fs=1&" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="560" height="340"></embed></object></div>';
		}
		else
		{
			return "";
